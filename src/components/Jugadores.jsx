...
const styles = StyleSheet.create({
  jugadorFila: {
    ...
    // React Native no soporta :hover ni cursor
  },
  th: {
    padding: 12,
  ...
  contenedorTabla: {
    ...
    width: '50%', // Esto podría necesitar ajuste dependiendo del layout de tu aplicación
    alignSelf: 'center', // Esto centrará la "tabla" horizontalmente
    // border-collapse no es aplicable en React Native
    shadowColor: '#000', // Propiedades para la sombra en iOS
    shadowOffset: { width: 0, height: 0 },
    shadowOpacity: 0.2,
    shadowRadius: 15,
    elevation: 20, // Propiedad para la sombra en Android
    overflow: 'hidden', // Esconde el contenido que se desborde
    borderRadius: 8, // Bordes redondeados
    backgroundColor: 'rgba(255, 255, 255, 0.5)', // Color de fondo con transparencia
    // margin: 40px auto no tiene un equivalente directo en React Native. 
    // Puedes usar marginVertical y marginHorizontal para un efecto similar
    marginVertical: 40,
